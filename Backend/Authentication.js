/*
This file handles authentication for user emails and passwords. It verifies that
the user's login information is correct and matches the information stored in
the databases.
*/
